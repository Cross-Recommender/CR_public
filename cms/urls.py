...
urlpatterns = [
    ...
    #path('guest_password_change/', views.GuestPasswordChange.as_view(), name='guest_password_change'), #追加
    #path('guest_password_change/done/', views.GuestPasswordChangeDone.as_view(), name='guest_password_change_done'), #追加
